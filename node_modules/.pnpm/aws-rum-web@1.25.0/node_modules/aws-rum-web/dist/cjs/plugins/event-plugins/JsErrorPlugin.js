...
exports.JsErrorPlugin = exports.JS_ERROR_EVENT_PLUGIN_ID = void 0;
var InternalPlugin_1 = require("../InternalPlugin");
var constant_1 = require("../utils/constant");
var js_error_utils_1 = require("../utils/js-error-utils");
exports.JS_ERROR_EVENT_PLUGIN_ID = 'js-error';
var defaultConfig = {
...
var JsErrorPlugin = /** @class */ (function (_super) {
    ...
    function JsErrorPlugin(config) {
        var _this = _super.call(this, exports.JS_ERROR_EVENT_PLUGIN_ID) || this;
    ...
    JsErrorPlugin.prototype.recordJsErrorEvent = function (error) {
        var _a;
        (_a = this.context) === null || _a === void 0 ? void 0 : _a.record(constant_1.JS_ERROR_EVENT_TYPE, (0, js_error_utils_1.errorEventToJsErrorEvent)(error, this.config.stackTraceLength));
    };
