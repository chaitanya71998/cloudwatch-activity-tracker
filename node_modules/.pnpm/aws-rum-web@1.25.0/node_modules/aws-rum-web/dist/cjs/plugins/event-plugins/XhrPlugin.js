    ...
    function XhrPlugin(config) {
        ...
        _this.handleXhrErrorEvent = function (e) {
            ...
            if (xhrDetails) {
                ...
                _this.recordTraceEvent(xhrDetails.trace);
                _this.recordHttpEventWithError(xhrDetails, xhr, new XhrError_1.XhrError(errorMessage));
            }
        };
        ...
        _this.initializeTrace = function (xhrDetails) {
            ...
            xhrDetails.trace = (0, http_utils_1.createXRayTraceEvent)(_this.config.logicalServiceName, startTime, _this.context.config.enableW3CTraceId);
                    ...
                    if (xhrDetails) {
                        ...
                        if (!self.isSyntheticsUA &&
                            ...
                            if (self.context.config.enableW3CTraceId) {
                                this.setRequestHeader(http_utils_1.W3C_TRACEPARENT_HEADER_NAME, (0, http_utils_1.getW3CTraceIdHeaderValue)(xhrDetails.trace.trace_id, xhrDetails.trace.subsegments[0].id));
                            }
                            else {
