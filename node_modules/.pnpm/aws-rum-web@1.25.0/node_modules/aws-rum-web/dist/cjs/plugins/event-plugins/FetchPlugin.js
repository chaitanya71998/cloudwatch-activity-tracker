...
var FetchPlugin = /** @class */ (function (_super) {
    ...
    function FetchPlugin(config) {
        ...
        _this.beginTrace = function (input, init, argsArray) {
            ...
            var xRayTraceEvent = (0, http_utils_1.createXRayTraceEvent)(_this.config.logicalServiceName, startTime, _this.context.config.enableW3CTraceId);
        ...
        _this.addXRayTraceIdHeader = function (input, init, argsArray, xRayTraceEvent) {
            if (input.headers) {
                return (0, http_utils_1.addAmznTraceIdHeaderToHeaders)(input.headers, xRayTraceEvent.trace_id, xRayTraceEvent.subsegments[0].id, _this.context.config.enableW3CTraceId);
            }
            if (!init) {
                init = {};
                [].push.call(argsArray, init);
            }
            (0, http_utils_1.addAmznTraceIdHeaderToInit)(init, xRayTraceEvent.trace_id, xRayTraceEvent.subsegments[0].id, _this.context.config.enableW3CTraceId);
        };
        ...
        _this.fetch = function (original, thisArg, argsArray, input, init) {
            ...
            var traceHeader = (0, http_utils_1.getTraceHeader)(input.headers, _this.context.config.enableW3CTraceId);
