...
exports.NavigationPlugin = exports.NAVIGATION_EVENT_PLUGIN_ID = void 0;
...
var NavigationPlugin = /** @class */ (function (_super) {
    ...
    function NavigationPlugin(config) {
        ...
        _this.performanceNavigationEventHandlerTimingLevel1 = function () {
            var recordNavigation = function () {
                ...
                if ((_a = _this.context) === null || _a === void 0 ? void 0 : _a.record) {
                    _this.context.record(constant_1.PERFORMANCE_NAVIGATION_EVENT_TYPE, eventDataNavigationTimingLevel1);
                }
            };
        ...
        _this.performanceNavigationEventHandlerTimingLevel2 = function (entryData) {
            ...
            if ((_a = _this.context) === null || _a === void 0 ? void 0 : _a.record) {
                _this.context.record(constant_1.PERFORMANCE_NAVIGATION_EVENT_TYPE, eventDataNavigationTimingLevel2);
            }
        };
