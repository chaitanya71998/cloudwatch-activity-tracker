...
import { AwsCredentialIdentityProvider, AwsCredentialIdentity, HeaderBag } from '@aws-sdk/types';
...
export interface PartialConfig extends Omit<Partial<Config>, 'cookieAttributes'> {
