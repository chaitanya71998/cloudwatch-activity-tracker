...
exports.VisuallyReadySearch = void 0;
...
var VisuallyReadySearch = /** @class */ (function () {
    ...
    VisuallyReadySearch.prototype.initListeners = function () {
        ...
        this.lcpSupported = (0, common_utils_1.isLCPSupported)();
        this.fcpSupported = (0, common_utils_1.isFCPSupported)();
        // Use web vitals library for LCP and FCP, if supported
        if (this.fcpSupported) {
            this.fcpTime = undefined;
            (0, web_vitals_1.onFCP)(function (metric) { return _this.handleWebVitals(metric); });
        }
        if (this.lcpSupported) {
            this.lcpTime = undefined;
            (0, web_vitals_1.onLCP)(function (metric) { return _this.handleWebVitals(metric); });
        }
    };
    return VisuallyReadySearch;
}());
exports.VisuallyReadySearch = VisuallyReadySearch;
